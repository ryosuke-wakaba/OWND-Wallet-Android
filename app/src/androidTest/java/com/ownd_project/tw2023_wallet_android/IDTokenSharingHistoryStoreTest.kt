...
class IDTokenSharingHistoryStoreTest {
    ...
    fun testSaveAndGetAllHistories2History() = runBlocking {
        ...
        val history1 = com.ownd_project.tw2023_wallet_android.datastore.IdTokenSharingHistory.newBuilder()
            .setRp("someRp1")
            .setAccountIndex(1)
            .setCreatedAt(
                Timestamp.newBuilder()
        ...
        val history2 = com.ownd_project.tw2023_wallet_android.datastore.IdTokenSharingHistory.newBuilder()
            .setRp("someRp2")
            .setAccountIndex(2)
            .setCreatedAt(
                Timestamp.newBuilder()
